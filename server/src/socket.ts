...
//     // We'll remember which teams this socket joined and which user it belongs to
...
//           // persist in Mongo (sender is a User ObjectId string)
...
//           // broadcast to EVERY client in the team room (including sender)
